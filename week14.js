...
const myInformation=['Alice',19,'February','Aquarius'];
...
const changedCountries=countries.shift();
...
russianCities.unshift('Санкт-Петербург','Москва','Екатеринбург');
